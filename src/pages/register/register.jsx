    ...
    return(
      ...
      <div className="register-container">
        <div className="register-form">
          ...
          <div className="register-content">
            ...
            <br />
            <Input placeholder="Tên người dùng" className="inputText" 
             value = {name}
            ...
            <label>Sđt</label>
            <br />
            <Input placeholder="Số điện thoại" className="inputText" 
             value = {phone}
            ...
            <br />
            <Input placeholder="Mật khẩu" type="password" className="inputText"
            value={password}
            ...
            <br />
            <Input placeholder="Nhập Lại Mật Khẩu" type="password" className="inputText"
            value={cfpassword}
      ...
      >
        ...
        <Modal.Actions>
          ...
          {
            password=== cfpassword &&
          <Button primary onClick={() => (history.push("/login"), setOpenDialog(false))}>
            Đăng nhập
          </Button>
          }
        </Modal.Actions>
